...
echo -e "1.本安装脚本完全开源免费，请详情请查阅："
echo -e "2.本安装脚本基于腾讯GPU云工作平台进行了部分修改，可能会出现运行不稳定，出现疑难杂症等问题，不建议在其他环境使用"
echo -e "3.本安装脚本仅为了方便操作而制作，作者不负任何使用后果，若在安装过程中出现问题请在github上反馈，安装完成后任何bug作者理论上均不负责进行任何维护"
echo -e "4.请确保你已经了解这些知识：内网穿透、终端指令、python中的报错解决方式"
echo -e "5.报错问题请找GPT解决!不要找作者！${NOCOLOR}"
echo -e "${RED}特殊警告：此脚本完全开源，请不要将其以及修改补丁整合进任何付费整合包内使用！违者s全家！！！${NOCOLOR}"
echo -e "                        "
